	...
	public static void main(String[] args) 
	{
        ...
        JPanel renderPanel = new JPanel() 
        {
                ...
                public void paintComponent(Graphics g) 
                {
                    ...
                    Matrix4 scale = Matrix4.scale(1.3, 2.0, 0.8);
                    ...
                    Matrix4 translation = Matrix4.translate(220.0, 210.0, 343.0);
                    		...
                    		for (int x = minX; x<=maxX; x++)
                    		{
                    		    ...
                    		    if (b1 >= 0 && b1 <= 1 && b2 >= 0 && b2 <= 1 && b3 >= 0 && b3 <= 1) //img.setRGB(x, y, t.color.getRGB());
                    		    {
                    		    	...
                    		    	if (zBuffer[zIndex] < depth) 
                    		    	{
                    		    		...
                    		    		//.int test = t.color.getRed() >> 24 + ( (int) (t.color.getRed() * b1)) >> 16 + ( (int) (t.color.getGreen() * b2)) >> 8 +
                    		    		//		( (int) (t.color.getBlue() * b3));
                    		    		
                    		    		DrawUtils.DrawPixel(img, x, y, test);
                    		    		//DrawUtils.DrawPixel(img, x, y, t.color.getRGB());
